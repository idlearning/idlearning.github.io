...
export const Route = createFileRoute("/news")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Latest news, awards, and announcements from the Interaction Design for Learning Lab.",
      },
...
const DEFAULT_WRAP = "h-40 overflow-hidden bg-gray-100 flex items-center justify-center";
const DEFAULT_IMG = "w-full h-full object-cover";
    ...
    <main className="pb-20 pt-12 px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        {NEWS.map((item) => (
          ...
          >
            <div className={item.wrapClass ?? DEFAULT_WRAP}>
              <img alt={item.title} className={item.imgClass ?? DEFAULT_IMG} src={item.img} />
            </div>
