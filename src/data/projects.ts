...
export const PROJECTS: Project[] = [
  ...
  {
    id: "virtual-training-developmental-disabilities",
    titleKo: "발달장애인 대상 가상 훈련콘텐츠의 효과 검증을 위한 실험연구",
    titleEn:
      "Experimental Study to Evaluate the Effectiveness of Virtual Training Contents for People with Developmental Disabilities",
  ...
  {
    id: "k-edu-ict-policy-guidelines",
    titleKo: "K-Edu 교육정보화: 정책적 가이드라인과 역사",
    titleEn: "K-Edu ICT in Education: Policy Guidelines and History",
  ...
  {
    id: "mobile-online-content-developing-countries",
    titleKo: "개도국 교원 역량개발을 위한 모바일 기반 온라인 콘텐츠 설계, 개발 및 운영 전략 연구",
    titleEn:
      "Research on Mobile-based Online Content Design, Development and Operation Strategy for Promoting Teacher Competencies in Developing Countries",
  ...
  {
    id: "educational-ai-recommender-systems",
    titleKo:
      "교육용 인공지능 플랫폼 추천 시스템 설계 및 효과성 검증: 선호일치 및 불일치 기반 추천을 중심으로",
    titleEn:
  ...
  {
    id: "gamified-multimodal-english-indonesia",
    titleKo: "",
    titleEn:
      "Gamified multimodal English language learning with mobile phones for Indonesia Classrooms",
    period: "2018/10/01 - 2019/01/31",
  ...
  {
    id: "affective-feedback-moocs",
    titleKo: "MOOCs 학습환경에서 감성컴퓨팅 기술을 활용한 감성적 피드백 설계 및 효과성 검증",
    titleEn:
      "Design and Efficacy Investigation of Affective Feedback based on Affective Computing Technology in MOOCs Learning Environments",
  ...
  {
    id: "ewha-core-competence-assessment",
    titleKo: "이화핵심역량진단평가(ECCA: Ewha Core Competence Assessment) 개발을 위한 정책과제",
    titleEn: "Policy Research on the Development of Ewha Core Competence Assessment",
    period:
  ...
  {
    id: "edunext-digital-learning-tools",
    titleKo: "클라우드 기반 다양한 디지털 교구 활용 교육이 학생들에게 미치는 영향 등에 관한 연구",
    titleEn:
      "EduNEXT: The Impact of Cross-Context Design-Focused Digital Learning Tools on Learning in Korea",
  ...
  {
    id: "knowledge-contents-mid-long-term-plan",
    titleKo: "지식콘텐츠 개발 및 도입 중장기 계획 수립에 관한 연구",
    titleEn:
      "Research on the Mid-to-Long-Term Planning for the Development and Adoption of Knowledge Contents",
  ...
  {
    id: "mobile-gamification-mongolia",
    titleKo: "",
    titleEn:
      "Mobile Gamification-based Language Learning in Mongolia Toward a Participatory Learning Mode",
    period: "2016/06/01 - 2017/02/28",
  ...
  {
    id: "embodied-participatory-simulation",
    titleKo: "체화된 인지 이론의 관점에서 협동적 체감 학습 시뮬레이션 개발 및 효과성 연구",
    titleEn:
      "Research on the Development of Embodied Participatory Simulation and its Effects from Embodied Cognition Perspectives",
